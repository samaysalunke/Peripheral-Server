...
#define WIFI_SPI_INTR_RX_MASK           (0u)
#define WIFI_SPI_INTR_TX_MASK           (0u)
...
#define WIFI_UART_RX_BUFFER_SIZE        (8u)
#define WIFI_UART_TX_BUFFER_SIZE        (8u)
#define WIFI_UART_MP_MODE_ENABLE        (0u)
#define WIFI_UART_MP_ACCEPT_ADDRESS     (0u)
#define WIFI_UART_MP_RX_ADDRESS         (2u)
#define WIFI_UART_MP_RX_ADDRESS_MASK    (255u)

#define WIFI_UART_INTERRUPT_MODE        (0u)

#define WIFI_UART_INTR_RX_MASK          (0u)
#define WIFI_UART_INTR_TX_MASK          (0u)
