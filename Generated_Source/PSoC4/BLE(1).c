...
{
    { 0x02u, 0x01u, 0x06u, 0x13u, 0x09u, 0x4Du, 0x61u,
    0x73u, 0x74u, 0x65u, 0x72u, 0x50u, 0x65u, 0x72u, 0x69u,
    0x70u, 0x68u, 0x53u, 0x65u, 0x72u, 0x76u, 0x65u, 0x72u,
...
CYBLE_GAPP_SCAN_RSP_DATA_T cyBle_scanRspData =
{
    ...
    0x15u,      /* uint8 scan_rsp_data_length */
};
