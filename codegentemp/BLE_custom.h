...
#define CYBLE_SENDDATA_SERVICE_INDEX   (0x00u) /* Index of SendData service in the cyBle_customs array */
#define CYBLE_SENDDATA_DATA_CHAR_INDEX   (0x00u) /* Index of Data characteristic */
#define CYBLE_SENDDATA_DATA_CUSTOM_DESCRIPTOR_DESC_INDEX   (0x00u) /* Index of Custom Descriptor descriptor */
#define CYBLE_SENDDATA_DATA_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x01u) /* Index of Client Characteristic Configuration descriptor */


#define CYBLE_SENDDATA_SERVICE_HANDLE   (0x000Cu) /* Handle of SendData service */
#define CYBLE_SENDDATA_DATA_DECL_HANDLE   (0x000Du) /* Handle of Data characteristic declaration */
#define CYBLE_SENDDATA_DATA_CHAR_HANDLE   (0x000Eu) /* Handle of Data characteristic */
#define CYBLE_SENDDATA_DATA_CUSTOM_DESCRIPTOR_DESC_HANDLE   (0x000Fu) /* Handle of Custom Descriptor descriptor */
#define CYBLE_SENDDATA_DATA_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0010u) /* Handle of Client Characteristic Configuration descriptor */
