// ======================================================================
// Peripheral Server WDT Notification.v generated from TopDesign.cysch
// 03/14/2017 at 09:47
...
module BLE_v3_30_0 (
	...
	cy_clock_v1_0
		#(.id("b3ab9b16-dd62-4841-b877-f1f1b2e72e50/5ae6fa4d-f41a-4a35-8821-7ce70389cb0c"),
...
module SCB_P4_v3_20_2 (
	...
	cy_clock_v1_0
		#(.id("692c4efb-3be1-4a9a-ac02-e14564cc1ab7/2dc2d7a8-ce2b-43c7-af4a-821c8cd73ccf"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("692c4efb-3be1-4a9a-ac02-e14564cc1ab7/23b8206d-1c77-4e61-be4a-b4037d5de5fc"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("692c4efb-3be1-4a9a-ac02-e14564cc1ab7/78e33e5d-45ea-4b75-88d5-73274e8a7ce4"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
